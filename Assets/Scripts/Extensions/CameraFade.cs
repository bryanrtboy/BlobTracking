...
namespace Extensions
{
	...
	public class CameraFade : MonoBehaviour
	{
		...
		// Settings for the audio mixer to use normally.
		[SerializeField] private AudioMixerSnapshot m_FadedSnapshot;
		// Settings for the audio mixer to use when faded out.
...
//			m_FadeImage.enabled = false;
		...
		public void SetImageState (bool enabled)
		{
			if (m_FadeImage)
				m_FadeImage.enabled = enabled;
		}
	}
}